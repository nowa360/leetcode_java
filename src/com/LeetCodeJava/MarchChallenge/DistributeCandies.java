...
/*
March 1 Challenge - Distribute Candies
...
public class DistributeCandies {
    public int distributeCandies(int[] candyType) {
        ...
        List<Integer> list = Arrays.stream(candyType).boxed().collect(Collectors.toList());
        Set<Integer> candySet = new HashSet<Integer>(list);

        return Math.min(maxType, candySet.size());
    }
}
